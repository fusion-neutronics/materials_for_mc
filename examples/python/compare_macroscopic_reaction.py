...
mat1.add_nuclide('Be9',1)
mat1.set_density('g/cm3', 2.)
openmc_energies, openmc_xs = openmc.calculate_cexs(mat1, [16], temperature=294)
...
plt.title('Be9 Neutron Macroscopic Cross Section Comparison')
plt.legend()
# plt.xscale('log')
# plt.yscale('log')
plt.grid(True)
